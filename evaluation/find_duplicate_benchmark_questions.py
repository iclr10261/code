...
if __name__ == "__main__":
    ...
    # if the benchmark is cbt-cn, append cbt-ne :) this is because there is question overlap between these two benchmarks
    if args.benchmark == "cbt-cn":
        cbt_ne = benchmarks.load_benchmark("cbt-ne")
        benchmark_ds = concatenate_datasets([benchmark_ds, cbt_ne])
